...
exports.groupController = exports.chatController = exports.sendMessageController = exports.viewsController = exports.instanceController = exports.webhookController = exports.waMonitor = exports.repository = void 0;
...
exports.repository = new repository_manager_1.RepositoryBroker(messageRepository, chatRepository, contactRepository, messageUpdateRepository, webhookRepository, authRepository, db_connect_1.dbserver === null || db_connect_1.dbserver === void 0 ? void 0 : db_connect_1.dbserver.getClient());
exports.waMonitor = new monitor_service_1.WAMonitoringService(event_config_1.eventEmitter, env_config_1.configService, exports.repository);
...
exports.instanceController = new instance_controller_1.InstanceController(exports.waMonitor, env_config_1.configService, exports.repository, event_config_1.eventEmitter, authService);
