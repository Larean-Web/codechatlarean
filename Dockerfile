...
ENV STORE_CLEANING_INTERVAL=17200
ENV STORE_MESSAGE=true
ENV STORE_CONTACTS=false
ENV STORE_CHATS=false

ENV DATABASE_ENABLED=true
ENV DATABASE_CONNECTION_URI='mongodb://mongo:Lucas102030@easypanel.larean.com.br:27017/?authSource=admin&readPreference=primary&ssl=false&directConnection=true'
...
ENV AUTHENTICATION_API_KEY='Lucas102030@'
